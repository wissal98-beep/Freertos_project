...
#ifndef __LSM6DS3IMU_PORT_H__
#define __LSM6DS3IMU_PORT_H__
...
LSM6DS3_status_t LSM6DS3Core_readRegisterRegion(uint8_t*, uint8_t, uint8_t );

//readRegister reads one 8-bit register
LSM6DS3_status_t LSM6DS3Core_readRegister(uint8_t*, uint8_t);

//Reads two 8-bit regs, LSByte then MSByte order, and concatenates them.
//  Acts as a 16-bit read operation
LSM6DS3_status_t LSM6DS3Core_readRegisterInt16(int16_t*, uint8_t offset );

//Writes an 8-bit byte;
LSM6DS3_status_t LSM6DS3Core_writeRegister(uint8_t, uint8_t);
...
#endif  // End of __LSM6DS3IMU_PORT_H__ definition check
